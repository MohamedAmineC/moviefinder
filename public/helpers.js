...
const createMovieReleaseDate = (releaseDate) => {
  ...
  releaseParagraph.setAttribute('id','movieReleaseDate');
  releaseParagraph.innerHTML = 'Release Date : ' + releaseDate;
...
const displayMovie = (movieInfo) => {
    ...
    const movieHomePage = createMovieHomepage(movieInfo.homepage);
    // Append title, poster, and overview to page
    moviePosterDiv.appendChild(moviePoster);
    movieTextDiv.appendChild(titleHeader);
    movieTextDiv.appendChild(overviewText);
    movieTextDiv.appendChild(releaseDate);
    movieButton.appendChild(movieHomePage);
    showBtns();
